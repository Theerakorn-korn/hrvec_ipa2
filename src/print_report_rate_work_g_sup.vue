  ...
  <v-app>
    ...
    >
      <div class="page">
        <div align="center">
          <div class="head">
            รายงานอัตรากำลังสายสนับสนุนการสอน ประจำปีการศึกษา {{ year_result }}
          </div>
        </div>
        <table class="table" border="1" width="100%" align="center">
          <thead>
            <tr>
              ...
              <td align="center" width="5%" rowspan="3">จำนวนอัตรากำลังบุคลากรสายสนับสนุนการสอนจากการคำนวณ</td>
              <td align="center" width="5%" rowspan="3">จำนวนอัตรากำลังบุคลากร 38 ค.(2)</td>
              <td align="center" width="5%" rowspan="3">จำนวนอัตรากำลังพนักงานราชการสนับสนุนการสอนของสถานศึกษาที่มี</td>
              <td align="center" width="5%" rowspan="3">จำนวนลูกจ้างประจำของสถานศึกษาที่มี</td>
              <td align="center" width="5%" rowspan="3">รวมจำนวนบุคลากรของสถานศึกษาที่มีทั้งหมด</td>             
              <td align="center" width="10%" colspan="2">อัตรากำลังบุคลากรสายสนับสนุนการสอน จากการคำนวณตามเกณฑ์ ก.ค.ศ.</td>                  
            </tr>
            <tr>           
              <td align="center" rowspan="2">± จำนวน ตามเกณฑ์(+ เกิน / - ขาด)</td>               
            </tr>         
          </thead>
          <tbody>
            <tr v-for="(item, index) in process_transfers" :key="item.rate_work_g_id">
              ...
              <td align="center">{{ parseInt(item.rate_work_g_sup_ta_official) + parseInt(item.rate_work_g_sup_tb_civil) }}</td>       
              <td align="center">{{ item.rate_work_g_sup_ta }}</td>            
              <td align="center">{{ item.rate_work_g_sup_tb }}</td>            
              <td align="center">{{ item.rate_work_g_pte_ta }}</td>            
              <td align="center">{{ parseInt(item.rate_work_g_sup_ta)+parseInt(item.rate_work_g_sup_tb)+parseInt(item.rate_work_g_pte_ta) }}</td>            
              <td align="center">{{  parseInt(item.rate_work_g_sup_ta)+parseInt(item.rate_work_g_sup_tb)+parseInt(item.rate_work_g_pte_ta) - (parseInt(item.rate_work_g_sup_ta_official) + parseInt(item.rate_work_g_sup_tb_civil))  }}</td>            

                ...
                <v-card-text>
                  <v-form ref="deleteperiod_collegeform" lazy-validation>
                    <v-container grid-list-md>
                      <v-layout wrap>
                        <v-flex xs12>
                          ยืนยันการลบรายการ {{ editperiod_college.id_pr_c }} :
                  ...
                  <v-layout wrap>
                    ...
                    <v-flex xs12 md6>
                      <v-text-field
                        ...
                        v-model="editperiod_college.period_college_cal_end"
                        required
                        :rules="[v => !!v || '']"
                      ></v-text-field>
                    </v-flex>
...
export default {
  ...
  methods: {
    ...
    async addperiod_collegeSubmit() {
      ...
      else this.addperiod_college.period_college_enable = "0";
    ...
    async period_collegeEdit(id_pr_c) {
      ...
      else this.editperiod_college.period_college_enable_sw = false;
    ...
    async editperiod_collegeSubmit() {
      ...
      else this.editperiod_college.period_college_enable = "0";

          ...
          <template v-slot:[`item`]="{ item, index }">
            <tr>
              <td class="text-center">
                <v-checkbox
                  v-model="search"
                  :value="item.new_college"
                ></v-checkbox>
              </td>
              <td class="text-center">{{ index + 1 }}</td>
              <td class="text-center">{{ item.new_college }}</td>
              <td class="text-center">{{ item.count_manpower }}</td>
              <td class="text-center">
              ...
              <td class="text-center">{{ item.sequence_n }}</td>
              <td class="text-center">{{ item.id_branch_tran }}</td>
              <td class="text-center">{{ item.name_branch }}</td>
              <td class="text-center">{{ item.frist_lastname }}</td>
              <td class="text-center">{{ item.position_name }}</td>
              <td class="text-center">{{ item.id_postion }}</td>
              <td class="text-center">{{ item.old_college }}</td>
              <td class="text-center">
  ...
  methods: {
    ...
    async select_idPosition(tid_ref, id_tfl) {
      let result_con = await this.$http.post(
        "transference_location_detail.php",
        {
          ApiKey: this.ApiKey,
          id_ref: tid_ref
        }
      ...
      let result = await this.$http.post("transference_location_detail.php", {
        ApiKey: this.ApiKey,
        id_tfl: id_tfl
      });

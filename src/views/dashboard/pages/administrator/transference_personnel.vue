...
async mounted() {      
    ...
    methods: {
      ...
      async transference_personnelEdit(id_rc) {
        let result = await this.$http.post('transference_personnel.php', {
          ApiKey: this.ApiKey,
          id_rc: id_rc
        })
        this.edittransference_personnel = result.data      
        this.edittransference_personneldialog = true
      },
      async edittransference_personnelSubmit() {
        if (this.$refs.edittransference_personnelform.validate()) {
          this.edittransference_personnel.ApiKey = this.ApiKey;        
          let result = await this.$http.post('personnel_temporary.update.php', this.edittransference_personnel)
          ...
          this.edittransference_personneldialog = false
        }
      },             
    },
    computed: {

  ...
  data() {
    return {
     ...
     ApiKey: 'HRvec2021',
      ...
      pagination: {},      
      headers: [       
        { text: "รหัสสถานศึกษา", align: "left", value: "collegeinfo_name" }, 
        { text: "ชื่อสถานศึกษา", align: "left", value: "collegeinfo_director" }, 
        { text: "อำเภอ", align: "left", value: "collegeinfo_directorphone" }, 
        { text: "จังหวัด", align: "left", value: "collegeinfo_directorpic" }, 
        { text: "ประเภท", align: "left", value: "collegeinfo_address" },       
        { text: "ประเภท", align: "left", value: "collegeinfo_phone" },       
        { text: "ประเภท", align: "left", value: "collegeinfo_fax" },       
        { text: "ประเภท", align: "left", value: "collegeinfo_email" }, 

                      ...
                      >
                        <template v-slot:[`item`]="{ item, index }">
                          <tr>
                            ...
                            <td class="text-left">
                              {{ course_college(item.rate_work_course_id) }}
                            </td>
                            <td class="text-center">
                              {{ item.update_time }}
                            </td>
                            <td class="text-center">
                              ...
                              small
                                  fab
                                  dark
                                  color="indigo" :to="'/college/rate_workforce_course/' + item.rate_work_course_id"><v-icon dark>
                                    mdi-plus
                                  </v-icon></v-btn>
                             <!--  <v-icon
                                large
                                ...
                                <v-flex md12>
                                  <v-row>
                                    <v-col cols="12" md="6" sm="6">
                                      ...
                                      <v-text-field
                                        v-model="addrate_work_g.rate_work_g_dr"
                                        dense
                                        filled
                                        type="number"
                                    ...
                                    <v-col cols="12" md="12">
                                      ...
                                      >
                                        <h2>
                                          รวมอัตรา : {{ addrate_work_g.sumall }}
                                        </h2>
                                      </v-alert>
                                    </v-col>
                                  </v-row>

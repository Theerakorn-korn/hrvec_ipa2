        ...
        <base-material-card color="primary">
          <template v-slot:heading>
            <h2 class="h1 font-weight-light text_google">
              <v-icon large left>mdi-file-send</v-icon>ประวัติเงือนไขในการรับย้าย
            </h2>
          </template>   
                  ...
                  <v-row>  
<v-col cols="12" sm="4">  
<v-select v-model="period_year" label="แสดงข้อมูล ประจำปี :" :items="year_select" item-text="year_select" item-value="year_select" @change="searchYear()">
</v-select>
</v-col>
<v-col cols="12" sm="12">
 
    <v-alert border="left" colored-border color="info darken-1" elevation="2"  type="info">
     <table width="100%" align="center" class="table">
        <tr>
            <th width="20%" class="regular16 th" align="center">อันดับ</th>
            <th width="20%" class="regular16 " align="center">คุณวุฒิ</th>
            <th width="50%" class="regular16 " align="left">สาขาวิชา</th>
      ...
      <table width="100%" align="center" class="table"
         ...
         >
          <tr>
            <td width="20%" class="regular12 th" align="center"> {{item.sequence_n}} </td>
            <td width="20%" class="regular12 " align="center"> {{item.educational_level}} </td>
            <td width="50%" class="regular12 "> {{item.id_branch}} {{item.name_branch}} </td>

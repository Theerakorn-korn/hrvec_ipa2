            ...
            <v-form ref="editpersonnel_temporaryform" lazy-validation>
              <v-container grid-list-md>
                <v-layout wrap> 
                  ...
                  <v-flex md6>
                    <v-text-field label="Password" v-model="editpersonnel_temporary.p_word" type="password"></v-text-field>
                  </v-flex>
                  <v-flex md6>
    ...
    loading: true,       
     ApiKey: 'HRvec2021',
      ...
      headers: [
        ...
        { text: "รหัส", align: "่left", value: "id_card" },    
        { text: "คำนำหน้าชื่อ", align: "่left", value: "title_s" },    
        { text: "ชื่อ", align: "่left", value: "frist_name" },         
        { text: "นามสกุล", align: "่left", value: "last_name" },         
        { text: "ตำแหน่ง", align: "่left", value: "position_name" }, 

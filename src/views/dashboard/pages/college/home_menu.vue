...
export default {
  ...
  snackbar: {
        ...
        user_system_items: [ 
          { text: "ข้อมูลผู้ใช้งานระบบ ข้าราชการครูและบุคลาการทางการศึกษา", icon: "mdi-account-arrow-right", to: "/college/personnel" },  
        ],

         college_items: [   
          { text: "ข้อมูลรายละเอียดสถานศึกษา", icon: "mdi-calendar", to: "/college/collegeinfo" },        
        ],

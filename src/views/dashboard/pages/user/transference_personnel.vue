...
<v-form v-if="transference_personnels.id_ref===id_ref">
...
<v-col cols="12" sm="12">
 <h3>ขอย้ายสับเปลี่ยนกับ : {{ personnel_temporarys.title_s }} {{ personnel_temporarys.frist_name }} {{ personnel_temporarys.last_name }}
               </h3>
</v-col>
                    <v-col cols="12" sm="6">                     
                      <v-text-field

    ...
    <v-row>
      <v-col cols="12" md="12">
        <base-material-card color="primary">
            ...
            <v-row>
              ...
              <v-col cols="12" sm="6" align="center">
                ...
                >
                  ...
                  <v-btn
                    v-if="transference_personnels.tid_ref === id_ref"
                    x-large
                    color="info"
                    dark
                    class="ma-2"
                    :href="'#/user/print_info/' + id_ref"
                    target="_blank"
                  >
          ...
          <v-form v-if="transference_personnels.tid_ref === id_ref">
          ...
          <v-form ref="addtransference_personnelform" lazy-validation v-else>
            ...
            >
              <v-card-title>
                <div class="font-weight-light v-size--x-large">
                  <v-icon large left>mdi-details</v-icon> เอกสารประกอบการพิจารณา
                </div>
              </v-card-title>

<template>
  <div>
    <v-container class="text_google">
      ...
      <v-layout row justify-center>
        <v-dialog v-model="addpersonnel_work_historydialog" persistent max-width="50%" overlay-opacity="0.6">
                  ...
                  <v-layout wrap>
                    <v-flex md12>
                      <v-row>
                        ...
                        <v-col cols="12" lg="6">
                          <v-select
                            v-model="addpersonnel_work_history.government_status"  
 ...
 <v-text-field
              ...
              <v-form ref="deletepersonnel_work_historyform" lazy-validation>
                <v-container grid-list-md>
                  <v-layout wrap>
                    <v-flex xs12>
                      ยืนยันการลบข้อมูล :
                      <h3>{{ editpersonnel_work_history.government_status }}</h3>
                    </v-flex>
      ...
      <v-layout row justify-center>
        <v-dialog v-model="editpersonnel_work_historydialog" persistent max-width="50%">
          <v-card class="mx-auto pa-5" >
            <base-material-card
              color="yellow"
              icon="mdi-clipboard-text"
                  ...
                  <v-layout wrap>
                    <v-flex md12>
                      <v-row>
                        ...
                        <v-col cols="12" lg="6">
                          <v-select
                            v-model="editpersonnel_work_history.government_status"  
...
let userSession = JSON.parse(sessionStorage.getItem('user')) || 0  
          ...
          let result = await this.$http.post('personnel_work_history.insert.php', this.addpersonnel_work_history)         

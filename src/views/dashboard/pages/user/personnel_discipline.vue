...
<!-- 
      ...
      <v-layout row justify-center>
        <v-dialog v-model="addpersonnel_disciplinedialog" persistent max-width="50%" overlay-opacity="0.6">
          <v-card class="mx-auto pa-5" >
            ...
            <v-card-text class="text_google">
              <v-form
                ref="addpersonnel_disciplineform"               
                lazy-validation                
              >
          ...
          >
            OK
              ...
              > <v-icon dark>mdi-content-save</v-icon>&nbsp;&nbsp;บันทึก</v-btn>
                      <v-btn  large color="warning" @click.stop="addpersonnel_disciplinedialog = false" rounded>
      ...
      <v-layout>
        <v-dialog v-model="deletepersonnel_disciplinedialog" persistent max-width="40%">
          <v-card class="mx-auto pa-5" >
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn large @click.stop="deletepersonnel_disciplinedialog = false">
                <v-icon dark>mdi-close</v-icon>ยกเลิก
              </v-btn>
      ...
      >
        ...
        >
          ...
          >
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn large  @click.stop="editpersonnel_disciplinedialog = false" rounded>
                <v-icon dark>mdi-close</v-icon>ยกเลิก
              </v-btn>
              <v-btn large color="warning" @click.stop="editpersonnel_disciplineSubmit()" rounded>
...
let userSession = JSON.parse(sessionStorage.getItem('user')) || 0  
          ...
          let result = await this.$http.post('personnel_discipline.insert.php', this.addpersonnel_discipline)         
